...
bool forward_kinematics(double* outputs, double* range_limits, double theta1, double theta2, double theta3, double a1, double a2, double a3) {
  ...
  if (theta1 < range_limits[0] || theta1 > range_limits[1] || 
      theta2 < range_limits[2] || theta2 > range_limits[3] || 
      theta3 < range_limits[4] || theta3 > range_limits[5]) {
  ...
  Serial.print("input x: "); Serial.println(outputs[0]);
  Serial.print("input y: "); Serial.println(outputs[1]);
  Serial.print("input z: "); Serial.println(outputs[2]);
  Serial.print("x coordinate: "); Serial.println(x);
  Serial.print("y coordinate: "); Serial.println(y);
  Serial.print("z coordinate: "); Serial.println(z);
